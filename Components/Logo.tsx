...
import { COLORS, LogoStyles } from "../style/style";

const Logo = (props: {backgroundColor?:ColorValue, textColor?:ColorValue}) => {

     

    return (
        <View style={{...LogoStyles.logoStyle, backgroundColor: props.backgroundColor}}>
